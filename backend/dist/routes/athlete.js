...
const orderValue_1 = require("../utils/orderValue");
const router = express_1.default.Router();
const prisma = new client_1.PrismaClient();
const DEFAULT_COMMISSION_RATE = 0.10;
function normalizeCodesForMatching(codes) {
    return [
        ...new Set([
            ...codes,
...
router.get("/profile", async (req, res) => {
    try {
        ...
        const discountCodes = coupons.map((coupon) => {
            ...
            const isFixedAmount = coupon.discount.includes("$") || /\$\s*\d+/.test(coupon.description || "");
...
router.put("/profile/social", async (req, res) => {
    try {
        ...
        const schema = zod_1.z.object({
            ...
            other: zod_1.z.string().trim().optional().nullable(),
        });
        ...
        const normalizedOther = data.other == null || data.other === "" ? null : data.other;
...
const deliverableSchema = zod_1.z.object({
    ...
    links: zod_1.z.array(zod_1.z.object({
        ...
        platform: zod_1.z.enum(["Instagram", "TikTok", "YouTube", "Other"]),
        customPlatformName: zod_1.z.string().optional(),
            ...
            data: {
                ...
                details: {
                    ...
                    platform: link.platform === "Other" && link.customPlatformName
                        ...
                        : link.platform,
                    originalPlatform: link.platform,
...
router.post("/sync-orders", async (req, res) => {
    try {
        ...
        for (const order of orders) {
            ...
            const orderValue = (0, orderValue_1.getCommissionableValue)(order);
            const commissionRate = (affiliate.commissionRate || 10) / 100;
...
router.post("/orders/create", async (req, res) => {
    try {
        ...
        const orderValue = (0, orderValue_1.getCommissionableValue)(shopifyOrder);
